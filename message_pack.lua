...
if not jit and _VERSION < 'Lua 5.3' then
    ...
    if NAKAMA then
        local header = {27,76,74,1,0,5,97,32,61,32,49,28}
...
if NAKAMA then
    ...
    floor = math.floor
    tointeger = math.tointeger or floor
    frexp = math.frexp 
    ldexp = math.ldexp
    huge = math.huge
    tconcat = table.concat
else
    char = require('string').char
    format = require('string').format
    floor = require('math').floor
    tointeger = require('math').tointeger or floor
    frexp = require('math').frexp or require('mathx').frexp
    ldexp = require('math').ldexp or require('mathx').ldexp
    huge = require('math').huge
    tconcat = require('table').concat
end
